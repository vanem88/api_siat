...
@Entity
@Table(name = "PASOCIACION_PAREJA_A", schema = "datosEveliaMinimo", catalog = "")
@IdClass(PasociacionParejaAEntityPK.class)
public class PasociacionParejaAEntity {
    ...
    public boolean equals(Object o) {
        ...
        PasociacionParejaAEntity that = (PasociacionParejaAEntity) o;
