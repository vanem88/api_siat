...
@Entity
@Table(name = "EVALUACION_ALUMNOS", schema = "datosEveliaMinimo", catalog = "")
@IdClass(EvaluacionAlumnosEntityPK.class)
public class EvaluacionAlumnosEntity {
    ...
    public boolean equals(Object o) {
        ...
        EvaluacionAlumnosEntity that = (EvaluacionAlumnosEntity) o;
