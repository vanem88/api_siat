...
@Entity
@Table(name = "PFORMATO_TABLA_RESPUESTAS", schema = "datosEveliaMinimo", catalog = "")
@IdClass(PformatoTablaRespuestasEntityPK.class)
public class PformatoTablaRespuestasEntity {
    ...
    public boolean equals(Object o) {
        ...
        PformatoTablaRespuestasEntity that = (PformatoTablaRespuestasEntity) o;
